                ...
                <tbody className='bg-white divide-y divide-gray-200 '>
                  {
                    bids.map(bid => <tr key={bid._id}>
                      ...
                      <td className='px-4 py-4 text-sm whitespace-nowrap'>
                        ...
                        <p
                            className={`px-3 py-1 ${bid.category === 'Web Development' && 'text-blue-500 bg-blue-100/60'} ${bid.category === 'Digital Marketing' && 'text-green-500 bg-green-100/60'} ${bid.category === 'Graphics Design' && 'text-red-500 bg-red-100/60'} text-xs  rounded-full`}
                          >
                            {bid.category}
                          </p>
                        </div>
